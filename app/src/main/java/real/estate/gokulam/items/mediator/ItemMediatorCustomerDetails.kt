package real.estate.gokulam.items.mediator
...
import real.estate.gokulam.views.mediator.MediatorPropertyDetails


class ItemMediatorCustomerDetails(var activity: FragmentActivity, var customerDetails: List<Customer>) : RecyclerView.Adapter<ItemMediatorCustomerDetails.ItemHolder>() {

    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ItemHolder {
        return ItemHolder(LayoutInflater.from(activity!!).inflate(R.layout.item_customer_in_mediator, null))
    }
    ...
    override fun onBindViewHolder(holder: ItemHolder, i: Int) {
        ...
        holder.parent_lay.setOnClickListener {
            ...
            val fragment = MediatorPropertyDetails()
