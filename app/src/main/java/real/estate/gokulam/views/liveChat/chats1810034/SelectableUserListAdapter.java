...
public class SelectableUserListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.chat_list_item_selectable_user, parent, false);
    ...
    private class SelectableUserHolder extends RecyclerView.ViewHolder {
        ...
        private void bind(final Context context, final User user, boolean isSelected, final OnItemCheckedChangeListener listener) {
            ...
            if(user.getOriginalProfileUrl()==null || user.getOriginalProfileUrl().isEmpty()){
                profileImage.setImageResource(R.drawable.add_user);
            }else{
                ImageUtils.displayRoundImageFromUrl(context, user.getOriginalProfileUrl(), profileImage);
            }
