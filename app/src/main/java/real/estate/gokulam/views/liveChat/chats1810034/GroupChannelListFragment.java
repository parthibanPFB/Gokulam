...
public class GroupChannelListFragment extends Fragment {
    ...
    private ImageView mCreateChannelFab;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.chat_fragment_group_channel_list, container, false);

        setRetainInstance(true);

        // Change action bar title
        ((GroupChannelActivity) getActivity()).setchatsList(getResources().getString(R.string.chats));
        ...
        emptyView =rootView.findViewById(R.id.no_data);
  ...
  /*              Intent intent = new Intent(getContext(), CreateGroupChannelActivity.class);
                startActivityForResult(intent, INTENT_REQUEST_NEW _GROUP_CHANNEL);*/
//                startActivity(new Intent(getActivity(),UserListActivity.class));
    ...
    private void setUpChannelListAdapter() {
        mChannelListAdapter.setOnItemClickListener(new GroupChannelListAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(GroupChannel channel, String type) {
