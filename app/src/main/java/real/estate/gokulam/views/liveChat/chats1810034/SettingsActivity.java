...
public class SettingsActivity extends AppCompatActivity {
    ...
    private ImageView mImageViewProfile,setting_backpress;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
     ...
     /*   Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_settings);
        ...
        setting_backpress =  findViewById(R.id.setting_backpress);
        chtLogOut =  findViewById(R.id.chat_logout);
...
//                PreferenceUtils.setNotificationsDoNotDisturbTo(String.valueOf(toMillis));
       ...
       /* mCheckBoxGroupChannelDistinct.setChecked(PreferenceUtils.getGroupChannelDistinct());
        ...
        setting_backpress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onBackPressed();
            }
        });
        chtLogOut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                            requestCamera();
    ...
    public void onActivityResult(int requestCode, int resultCode, final Intent data) {
        ...
        if (requestCode == INTENT_REQUEST_CHOOSE_MEDIA && resultCode == Activity.RESULT_OK) {
            ...
            try {
                profileImage = new File(PathUtil.getPath(activity,uri));
