...
public class CustomTextEditView extends TextInputEditText {

    private static final int DEFAULT_TYPE_FACE = 0;

    public CustomTextEditView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    public CustomTextEditView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
